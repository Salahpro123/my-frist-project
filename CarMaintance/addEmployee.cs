    ...
    public partial class addEmployee : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    con2007.Open();
                    string query = "INSERT INTO employee (IDEmployee, EmployeeName ,JopName ,phoneEmployee ,datetojoinEmployee ,photoEmployee) VALUES (@IDEmployee , @EmployeeName , @JopName , @phoneEmployee , @datetojoinEmployee , @photoEmployee)";
                    OleDbCommand cmd = new OleDbCommand(query, con2007);
                    cmd.Parameters.AddWithValue("@IDEmployee", txt_addEmployee_number.Text);
                ...
                {
                    MessageBox.Show("رقم الموظف مسجل من قبل او تم الادخال بشكل خاطى");
                }
            }
            con2007.Close();
        }
