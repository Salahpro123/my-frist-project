...
namespace CarMaintance
{
    public partial class addList : Form
    {
        ...
        public void DecreaseQuantity(int partid, int Quantity)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        con2007.Open();
                        string query = "INSERT INTO lists ([ListID], [IDCars], [IDEmployee], [PartID], [ServiceID], [Reports], [SupplierID], [datetimer]) VALUES (@ListID , @IDCars, @IDEmployee, @PartID, @ServiceID, @Reports, @SupplierID,@datetimer)";
                        string query3 = "INSERT INTO customerPayment ([CustomerMoney], [IDCars])  VALUES (@CustomerMoney , @dIDCars) ";
                        OleDbCommand cmd = new OleDbCommand(query, con2007);
                        OleDbCommand cmd3 = new OleDbCommand(query3, con2007);
                        cmd.Parameters.AddWithValue("@ListID", txt_number_list.Text);
                        ...
                        cmd.Parameters.AddWithValue("@datetimer", dateTimePicker1.Text);
                        ...
                        MessageBox.Show("تم اضافة السجل");
                    }
                    catch (Exception)
                    {
